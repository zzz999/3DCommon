...
$(function () {
    ...
    viewer.onMeshLoaded.add(function(){
        ...
        //自动旋转
        if(Api.autoRotate){
            viewer.AutoRotatePlugin.enableAutoRotate(true);
        }
    ...
    viewer.loadModel({
        m: 'u3d/qinghuaci/models/m.json',
        s: 'u3d/qinghuaci/tm.txt',
        t: [
            'u3d/qinghuaci/textures/t_1.txt',
            'u3d/qinghuaci/textures/t_2.txt',
            'u3d/qinghuaci/textures/t_3.txt'
        ],
        e: {
            'name': 'skybox',
            'urls': ['u3d/qinghuaci/envmap/hdr/px.hdr', 'u3d/qinghuaci/envmap/hdr/nx.hdr', 'u3d/qinghuaci/envmap/hdr/py.hdr', 'u3d/qinghuaci/envmap/hdr/ny.hdr', 'u3d/qinghuaci/envmap/hdr/pz.hdr', 'u3d/qinghuaci/envmap/hdr/nz.hdr']
        }
    });
    ...
    function initUI(){    
        ...
        //$('#btn-switchAutoRotate').on(startEventType,function(){
        //    if($(this).hasClass('active')){
        //        $(this).removeClass('active');
        //        $(this).find('img').attr('src','img/ks.png');
        //        viewer.AutoRotatePlugin.enableAutoRotate(false);
        //    }else{
        //        $(this).addClass('active');
        //        $(this).find('img').attr('src','img/zt.png');
        //        viewer.AutoRotatePlugin.enableAutoRotate(true);
        //    }
        //});
